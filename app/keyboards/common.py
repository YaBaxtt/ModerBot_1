...
def main_menu(is_owner: bool = False, *, bot_username: str | None = None, group_url: str | None = None, channel_url: str | None = None, features: dict[str, bool] | None = None) -> InlineKeyboardMarkup:
    ...
    rows = [
        ...
        [InlineKeyboardButton(text="⚙️ Настройки группы", callback_data="menu:group_settings", style=ButtonStyle.SUCCESS)],
        ...
        [InlineKeyboardButton(text=label("🛡 Модераторская", 'moderation'), callback_data="moder:home")],
    ]
    if is_owner:
